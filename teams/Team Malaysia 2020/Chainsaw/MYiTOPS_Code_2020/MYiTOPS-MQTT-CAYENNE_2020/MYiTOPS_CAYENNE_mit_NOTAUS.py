    ...
    try:
        while True:
            ...
            if OnOff_Flag:
                ...
                #Test Profile
                if (Kaltstart_Flag or Warmstart_Flag or Betrieb_Flag) and Motor_an_Flag and TestProfileButton_Flag and not Not_Aus_Flag and not TestProfile_Flag :
                    #testing2
