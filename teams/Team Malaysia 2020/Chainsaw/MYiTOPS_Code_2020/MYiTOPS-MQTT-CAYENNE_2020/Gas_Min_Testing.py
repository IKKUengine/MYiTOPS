...
class Servo:
    def __init__(self, pi, GPIO, Nullposition = 1500, min_Winkel = -20):   # Nullpostion gibt die Mittelstellung in Pulsweite an, durch Tests bestimmt
        self.GPIO = GPIO
...
Gas_Servo = Servo(pi, Gas_GPIO,1500, Winkel_Gas_min)
