    ...
    try:
        while True:
            ...
            if OnOff_Flag:
                ...
                if (Kaltstart_Flag or Warmstart_Flag or Betrieb_Flag) and Motor_an_Flag and Gas_Servo.Prozent != Throttle and not Not_Aus_Flag and TestProfileButton_Flag and Throttle == 0:
                    Test_Profile()
